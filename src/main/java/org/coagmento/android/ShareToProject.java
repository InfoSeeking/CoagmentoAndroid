...
public class ShareToProject extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_edit_snippet, menu);

        MenuItem item = menu.findItem(R.id.add_snippet);
    ...
    public void selectType() {
        ...
        builder.setItems(R.array.quickActions, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                String[] array = getResources().getStringArray(R.array.quickActions);
