...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.coagmento.mobile.R.layout.activity_splash_screen);

        //Hide the Action Bar for this activity
        getSupportActionBar().hide();

        // Start the Progress Bar Animation
        mProgress = (ProgressBar) findViewById(com.coagmento.mobile.R.id.splash_progressBar);
        ...
        String host = prefs.getString("host", getString(com.coagmento.mobile.R.string.server_base_url));
