...
import com.coagmento.mobile.fragment.ActivityFragment;
import com.coagmento.mobile.fragment.BookmarksFragment;
import com.coagmento.mobile.fragment.DocumentsFragment;
import com.coagmento.mobile.fragment.MainFragment;

import com.coagmento.mobile.fragment.SearchesFragment;
import com.coagmento.mobile.fragment.SnippetsFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.coagmento.mobile.R.layout.activity_main);
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if(preferences.getBoolean("pref_notification", false)) {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(com.coagmento.mobile.R.id.action_settings).setVisible(!(projectList.size() == 0));
        menu.findItem(R.id.action_chat).setVisible(!(projectList.size() == 0));
        return true;
    }
    ...
    protected void initializeUI() {
        ...
        // Set tabs on toolbar
        toolbar = (Toolbar) findViewById(com.coagmento.mobile.R.id.toolbar);
        setSupportActionBar(toolbar);

        // Find the floating action button
        floatingActionsMenu = (FloatingActionsMenu) findViewById(com.coagmento.mobile.R.id.fab);
        addBookmarkButton = (FloatingActionButton) findViewById(com.coagmento.mobile.R.id.add_bookmark_fab);
        addSnippetButton = (FloatingActionButton) findViewById(com.coagmento.mobile.R.id.add_snippet_fab);

        // Set User Name and Email in navigation header
        userAvatarView = (ImageView) findViewById(com.coagmento.mobile.R.id.userAvatarView);
        TextDrawable userAvatar = TextDrawable.builder()
                .beginConfig()
                .width(150)
                .height(150)
                .endConfig()
                .buildRound(String.valueOf(name.charAt(0)), com.coagmento.mobile.R.color.white);
        userAvatarView.setImageDrawable(userAvatar);

        mHeaderNameView = (TextView) findViewById(com.coagmento.mobile.R.id.navview_header_name);
        mHeaderNameView.setText(name);

        mHeaderEmailView = (TextView) findViewById(com.coagmento.mobile.R.id.navview_header_email);
        mHeaderEmailView.setText(email);

        // Set Up Navigation Drawer
        DrawerLayout drawer = (DrawerLayout) findViewById(com.coagmento.mobile.R.id.drawer_layout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, com.coagmento.mobile.R.string.navigation_drawer_open, com.coagmento.mobile.R.string.navigation_drawer_close);
        drawer.setDrawerListener(toggle);
        toggle.syncState();

        navigationView = (NavigationView) findViewById(com.coagmento.mobile.R.id.nav_view);
        ...
        navigationView.inflateMenu(com.coagmento.mobile.R.menu.activity_main_drawer);
        Menu menu = navigationView.getMenu();
        Menu myProjects = menu.findItem(com.coagmento.mobile.R.id.myProjects).getSubMenu();
        Menu sharedProjects = menu.findItem(com.coagmento.mobile.R.id.sharedProjects).getSubMenu();

        menuItemHashMap = new HashMap<>();
        projectIdHashMap = new HashMap<>();

        for (int i = 0; i < myProjectList.size(); i++) {
            MenuItem menuItem = myProjects.add(myProjectList.get(i).getTitle()).setIcon(com.coagmento.mobile.R.drawable.ic_keyboard_arrow_right_black_24dp);
        ...
        for (int i=0; i<sharedProjectList.size(); i++) {
            MenuItem menuItem = sharedProjects.add(sharedProjectList.get(i).getTitle()).setIcon(com.coagmento.mobile.R.drawable.ic_keyboard_arrow_right_black_24dp);
        ...
        if(projectList.size() != 0) {
            ...
            if(currentProject.getLevel().equals("w") || currentProject.getLevel().equals("o")) {
                findViewById(com.coagmento.mobile.R.id.fab).setVisibility(View.VISIBLE);
            } else {
                findViewById(com.coagmento.mobile.R.id.fab).setVisibility(View.INVISIBLE);
            }
        ...
        if(projectList.size() == 0) {
            toolbar.setTitle(com.coagmento.mobile.R.string.no_projects_found);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.coagmento.mobile.R.menu.main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.coagmento.mobile.R.id.action_settings) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == com.coagmento.mobile.R.id.nav_logout) {
            SharedPreferences prefs = getSharedPreferences("Login", 0);
            ...
            startActivity(intent);
            finish();
        } else if (id == com.coagmento.mobile.R.id.nav_new_project) {
        ...
        } else if (id == com.coagmento.mobile.R.id.nav_settings) {
