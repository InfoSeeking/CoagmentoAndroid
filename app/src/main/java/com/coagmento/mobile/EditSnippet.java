...
public class EditSnippet extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.coagmento.mobile.R.layout.activity_edit_snippet);

        b = getIntent().getExtras();

        titleView = (EditText) findViewById(com.coagmento.mobile.R.id.snippet_title_form);
        urlView = (EditText) findViewById(com.coagmento.mobile.R.id.snippet_url_form);
        textView = (EditText) findViewById(com.coagmento.mobile.R.id.snippet_description_form);
        addSnippet = (AppCompatButton) findViewById(com.coagmento.mobile.R.id.create_snippet_button);
        projectsSpinner = (AppCompatSpinner) findViewById(com.coagmento.mobile.R.id.snippets_project_snipper);
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(getString(com.coagmento.mobile.R.string.server_base_url))
