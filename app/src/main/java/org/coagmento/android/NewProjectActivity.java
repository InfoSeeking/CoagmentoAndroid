...
public class NewProjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleView = (EditText) findViewById(R.id.project_title_form);

        mDescriptionView = (EditText) findViewById(R.id.project_description_form);

        mPrivateView = (Switch) findViewById(R.id.project_privacy_switch);
